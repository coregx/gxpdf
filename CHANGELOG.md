...
### Added
- **PDF stream filter chains** — decode ordered filter arrays, aliases, LZW, ASCII85, ASCIIHex, RunLength, and Flate/LZW predictors through one bounded pipeline; image export uses the same path while preserving terminal DCT payloads and explicitly rejecting unsupported JPX payloads (#95)
